...
// Keywords for SEO or inventory metadata
interface IKeywords {
...
interface IPlatformInventoryInfo {
  inventoryCategory: Types.ObjectId;
...
// Update payload for inventory
export type IInventoryUpdatePayload = Partial<IInventory>;
