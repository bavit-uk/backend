...
export const LeadsCategoryController = {
  ...
  updateLeadsCategory: async (req: Request, res: Response) => {
    try {
      ...
      const updatedCategory = await LeadsCategoryService.editLeadsCategory(
        id,
        updateData
      );
  ...
  deleteLeadsCategory: async (req: Request, res: Response) => {
    try {
      ...
      const deletedCategory =
        await LeadsCategoryService.deleteLeadsCategory(id);
  ...
  searchAndFilterLeadCategory: async (req: Request, res: Response) => {
    try {
      ...
      const { leads, total } =
        await LeadsCategoryService.searchAndFilterLeadCategory(
          limitNum,
          skip,
          filter
        );
