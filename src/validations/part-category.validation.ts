...
import { PartCategoryCreatePayload, PartCategoryUpdatePayload } from "@/contracts/part-category.contract";
...
export const partCategoryValidation = {

  addCategory: async (
    req: IBodyRequest<PartCategoryCreatePayload>,
    res: Response,
    next: NextFunction
  ) => {
    console.log(req.body.name, req.body.description, req.body.image);
    const schema: ZodSchema = z.object({
      name: z.string().min(1, "Part Category Name is required"), // userType is required
  ...
  updateCategory: async (
    req: IBodyRequest<PartCategoryUpdatePayload>,
    res: Response,
    next: NextFunction
  ) => {
    console.log(req.body.name, req.body.description, req.body.image);
    const schema: ZodSchema = z.object({
      name: z.string().min(1, "Part Category Name is required").optional(), // userType is required
      description: z.string().optional(), // description is optional
